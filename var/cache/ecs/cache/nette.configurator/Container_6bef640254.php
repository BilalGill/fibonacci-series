...
class Container_6bef640254 extends _HumbugBoxc7aa196c4c1e\Nette\DI\Container
{
	protected $tags = [
	...
	public function createService048(): PHPStan\Reflection\FunctionReflectionFactory
	{
		return new class ($this) implements PHPStan\Reflection\FunctionReflectionFactory {
			...
			public function __construct(Container_6bef640254 $container)
			{
	...
	public function createServiceContainer(): Container_6bef640254
	{
		return $this;
	}
